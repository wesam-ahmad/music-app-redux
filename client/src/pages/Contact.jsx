...
function Contact() {
  return (
    <>
      ...
      <div className="container my-24 mx-auto md:px-6 mt-[8vh]">
            ...
            <div className="block rounded-lg bg-[hsla(0,0%,100%,0.7)] px-6 py-12 shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)]   md:py-16 md:px-12 -mt-[100px] backdrop-blur-[30px]">
              <div className="mb-12 grid gap-x-6 md:grid-cols-2 lg:grid-cols-4">
                ...
                <div className="mx-auto mb-12 text-center lg:mb-0">
                  ...
                  <h6 className="font-medium">Zarqa, zarqa</h6>
                </div>
                <div className="mx-auto mb-6 text-center md:mb-0">
                  ...
                  <h6 className="font-medium">+97724263427</h6>
                </div>
              ...
              <div className="mx-auto max-w-[700px]">
                <form>
                  ...
                  <button
                    ...
                    className="inline-block w-full rounded bg-primary px-6 pt-2.5 pb-2 text-xs font-medium uppercase leading-normal text-white bg-slate-600 shadow-[0_4px_9px_-4px_#3b71ca] transition duration-150 ease-in-out hover:bg-primary-600 hover:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.3),0_4px_18px_0_rgba(59,113,202,0.2)] focus:bg-primary-600 focus:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.3),0_4px_18px_0_rgba(59,113,202,0.2)] focus:outline-none focus:ring-0 active:bg-primary-700 active:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.3),0_4px_18px_0_rgba(59,113,202,0.2)] "
                  >
                    Send
                  </button>
                </form>
